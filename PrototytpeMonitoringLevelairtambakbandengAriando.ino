...
const float JARAK_AMAN_SENSOR = 1;  // ← Dead zone, air tidak boleh menyentuh sensor
const float LEVEL_PENUH       = 7;  // cm dari sensor → pompa NYALA
const float LEVEL_NORMAL      = 7.5;  // cm dari sensor → pompa MATI
